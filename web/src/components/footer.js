...
const Footer = ({ footerMenu, newsletter, showPopupNewsletter, blackFooter }) => {
  ...
  return (
    <>
      ...
      <footer id="footer" className={`${blackFooter ? "black-footer text-white ":""} pt-1em md:pt-1 pb-1em md:pb-desktop container text-mobileNav md:text-base flex flex-col uppercase left-0 md:block`}>
        <GridRow></GridRow>
