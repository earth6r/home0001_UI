...
const Layout = ({ mainMenu,infoSection,newsletter,strikeColor,pillColor,infoSectionBelow,showPopupNewsletter, blackFooter, rMenu, rnd = false, subMenu, footerMenu, children, onHideNav, onShowNav, showNav,  onHideSubNav, onShowSubNav, showSubNav, siteTitle, isHome, thinBanner, showThinBanner, bannerUrl, bannerUrlTitle }) => {
 ...
 useEffect(() => {
  ...
  <div className="flex flex-col justify-between h-full">
   ...
   <GridRow />
    ...
    <div id='page-content-wrapper' className={`${showThinBanner && !rnd ? "mt-16 md:mt-12 md:mt-16":"mt-8"} ${rnd ? "px-special" : ""} container pb-0 `}>{children}</div>
    {!rnd &&
